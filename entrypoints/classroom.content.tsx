...
function detectGradingDoc(): GradingDoc | null {
  const iframe = document.querySelector<HTMLIFrameElement>(
    'iframe[src*="/document/d/"], iframe[src*="/document/u/"][src*="/d/"], iframe[src*="/spreadsheets/d/"], iframe[src*="/spreadsheets/u/"][src*="/d/"], iframe[src*="/presentation/d/"], iframe[src*="/presentation/u/"][src*="/d/"]',
  );
  const dataEl = document.querySelector<HTMLElement>(
    '[data-url*="/document/d/"], [data-url*="/document/u/"][data-url*="/d/"], [data-url*="/spreadsheets/d/"], [data-url*="/spreadsheets/u/"][data-url*="/d/"], [data-url*="/presentation/d/"], [data-url*="/presentation/u/"][data-url*="/d/"]',
  );
