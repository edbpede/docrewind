...
// model (R5, §13.7), exactly like lib/core/timeline and the diagnostics shapes.
//
 ...
 *  Mirrors lib/core/timeline's delta accounting so the length curve and the timeline
