...
// content-free sanitized capture (lib/core/fixtures/sheets-captured.ts) through the SAME
...
import { SHEETS_CAPTURED_HISTORY } from "@/lib/core/fixtures/sheets-captured";
import { gridAtRevisionIndex } from "@/lib/core/sheets/reconstruction/snapshot";
import { runSheetsPipelineOverBodies } from "@/lib/core/worker/pipeline";
