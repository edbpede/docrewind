...
// persistence backend implements: the `idb` implementation (lib/platform/db.ts) and the
// in-memory twin (lib/platform/db.memory.ts) both satisfy `RevisionStore`, and the pure
