...
// wires every `lib/platform/settings.ts` item through `createResource` (read) + `setValue`
...
import PrivacySummary from "@/components/common/PrivacySummary";
import ThemeControl from "@/components/common/ThemeControl";
import { useThemeSync } from "@/components/common/theme-sync";
import CacheControls from "@/components/options/CacheControls";
import DiagnosticsPreferences from "@/components/options/DiagnosticsPreferences";
